...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_serverAPI__ = __webpack_require__(9);
/* global THREE */
...
__WEBPACK_IMPORTED_MODULE_0__utils_serverAPI__["a" /* default */].downloadShader('particle.frag').then(d1 => {
  __WEBPACK_IMPORTED_MODULE_0__utils_serverAPI__["a" /* default */].downloadShader('particle.vertex').then(d2 => {
    __WEBPACK_IMPORTED_MODULE_0__utils_serverAPI__["a" /* default */].downloadShader('protoplanet_position.frag').then(d3 => {
      __WEBPACK_IMPORTED_MODULE_0__utils_serverAPI__["a" /* default */].downloadShader('protoplanet_velocity.frag').then(d4 => {
        particleF = d1;particleV = d2;protoPF = d3;protoVF = d4;
        init();
        animate();
      });
    });
...
class ServerAPI {
  static downloadShader(filename) {
    return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/api/download/shader', {
